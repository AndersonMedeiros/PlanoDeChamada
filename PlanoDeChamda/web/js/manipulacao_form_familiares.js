...
$(document).ready(function(){
    ...
    $("#btnNovoDep").click(function(){
            ...
            $("#linha"+i).append('<div id="div_nome_dependente" class="qtd_div form-group col-md-4"><label id="lblDependente">Dependente: </label><b class="obg"> *</b><input class="form-control" type="text" id="txtNomeDependente'+i+'" name="txtNomeDependente" onblur="borda_input_text(this.id)"/></div>');
